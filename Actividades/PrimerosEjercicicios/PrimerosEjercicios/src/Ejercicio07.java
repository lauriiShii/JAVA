...
public class Ejercicio07 {
	...
	/**
	 * Suponiendo realizadas las siguientes sentencias de asignación: lado1 = 3;
	 * precio = 325.6; lado2 = 4; comprar = false; hipotenusa = 5; ch = ‘7’.
	 * Determinar cuáles de las expresiones siguientes dan un resultado booleano
	 * y cuáles no. Para aquellas que produzcan un resultado booleano determinar
	 * si el resultado es verdadero o falso. Para las que no lo sean, explicar
	 * la razón. Indicar también si existe alguna expresión errónea.
	 */
