...
decimales. Haz un programa que utilice las dos funciones, con enteros y con decimales.*/
	public static void main(String[] args) {
		...
		/** PEDIMOS DATOS */
		operacion = Teclado.cadena("¿Su operación sera decimal o con simples números enteros?\n(Su respuesta solo puede ser Decimal o Entera)");
		...
		case "Entera":
			...
			break;
		case "Decimal":
			numD1  = Teclado.numeroDouble("Introduce un número decimal: ");
			numD2 = Teclado.numeroDouble("Introduce un número decimal: ");
