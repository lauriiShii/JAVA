...
public class Teclado {
	...
	/**LECTURA DE UN CARACTER QUE CUMPLE UN PATRON PASADO COMO PARAMETRO**/
	public static char caracter(String mensaje, String patron){
		...
		do {
			...
			//CONTROLAMOS QUE SOLO INTRODUZCA UN UNICO CARACTER
			if (cadena.length() != 1)
				System.out.println("!ERROR! No ha introducido un solo caracter");
			
			//CONTROLAMOS QUE CUMPLA EL PATRON
			else if (!cadena.matches(patron))
				System.out.println("!ERROR! El caracter introducido no es correcto");

		} while (cadena.length() != 1 || !cadena.matches(patron)); 
		return cadena.charAt(0); //DEVOLVEMOS EL CARACTER EXTRAYENDOLO DE LA CADENA
	}
	...
	public static String cadena(String mensaje, String patron){
		...
		do {
			...
			//CONTROLAMOS QUE LA CADENA CUMPLA EL PATRON
	    if (!cadena.matches(patron))
	    	System.out.println("!ERROR! La cadena introducida no es correcta");
		...
		do {
			...
			try{
				do {
					...
					if(num<1 || num>2){
						System.out.println("¡ERROR! Elige la opción 1 o 2.");
						booleano = true;
					}
